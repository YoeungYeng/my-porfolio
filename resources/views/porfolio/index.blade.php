<x-layout.app>
    ...
    <section class="mt-10 mb-10 px-4 sm:px-6 lg:px-8">
        <h2 class="text-blue-500 hover:underline font-bold text-2xl sm:text-3xl transition-all animate-bounce duration-200">
            About me
        </h2>
    ...
    <section class="mb-10 px-4 sm:px-6 lg:px-8">
        <h2 class="text-blue-500 hover:underline font-bold text-2xl sm:text-3xl transition-all animate-bounce duration-200 mt-10">
            My Stats
        </h2>
        ...
        <div class="mt-6 p-4 sm:p-6 shadow space-y-4">
            ...
            <div class="space-y-4 shadow p-6 sm:p-10 rounded-xl flex flex-wrap items-center justify-center gap-6">
                ...
                <div class="w-full sm:w-56 md:w-60 rounded-xl flex justify-center items-center flex-col h-[160px] bg-gray-200 hover:scale-105 transition-all duration-200">
                    <h3 class="text-blue-500 text-3xl font-bold">4+</h3>
                    <p class="font-medium italic">Years IT Experience</p>
                </div>
                <div class="w-full sm:w-56 md:w-60 rounded-xl flex flex-col items-center justify-center h-[160px] bg-gray-200 hover:scale-105 transition-all duration-200">
    ...
    <section class="mb-10 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-6 p-4 sm:p-6 shadow space-y-4">
            ...
            <div class="shadow p-5 rounded-xl grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="w-full p-6 rounded-xl flex flex-col gap-4 bg-gray-200 hover:scale-105 transition-transform duration-200">
                    ...
                    <div class="flex flex-col flex-grow justify-between">
                        <p class="text-gray-600 text-base leading-7">
                            Graduated with a Bachelor's degree in Computer Science, focusing on software engineering, algorithms, and data structures.
                        </p>
                        <a href="#" target="_blank" class="mt-4 px-4 py-2 w-fit bg-blue-500 text-white rounded-xl hover:bg-blue-400 transition-colors duration-200">
                            View Certificate
                        </a>
                    </div>
                </div>
                ...
                <div class="w-full p-6 rounded-xl flex flex-col gap-4 bg-gray-200 hover:scale-105 transition-transform duration-200">
                    ...
                    <div class="flex flex-col flex-grow justify-between">
                        <p class="text-gray-600 text-base leading-7">
                            Learned how to build cross-platform mobile apps with Flutter & Dart, covering UI, state management, and API integration.
                        </p>
                        <a href="https://github.com/YoeungYeng/mobile_app" target="_blank" class="mt-4 px-4 py-2 w-fit bg-blue-500 text-white rounded-xl hover:bg-blue-400 transition-colors duration-200">
                            View Project
                        </a>
                    </div>
                </div>
                ...
                <div class="w-full p-6 rounded-xl flex flex-col gap-4 bg-gray-200 hover:scale-105 transition-transform duration-200">
                    ...
                    <div class="flex flex-col flex-grow justify-between">
                        <p class="text-gray-600 text-base leading-7">
                            Mastered backend development, building REST APIs, and understanding MVC architecture using the Laravel framework.
                        </p>
                        <a href="https://github.com/YoeungYeng/pixel-postion" target="_blank" class="mt-4 px-4 py-2 w-fit bg-blue-500 text-white rounded-xl hover:bg-blue-400 transition-colors duration-200">
                            View Project
                        </a>
                    </div>
                </div>
        ...
        <div class="mt-6 p-4 sm:p-6 shadow space-y-4">
            ...
            <div class="shadow p-6 sm:p-10 rounded-xl bg-gray-50">
                <div class="w-full rounded-xl p-6 bg-gray-200 hover:shadow-lg transition-shadow duration-200">
                    ...
                    <div class="mb-4 flex flex-col sm:flex-row justify-between items-start sm:items-center w-full gap-2">
                    ...
                    <ul class="list-disc list-inside space-y-2">
                        <li class="text-base text-gray-600">Developed and maintained full-stack web applications using Laravel, Vue.js, and MySQL.</li>
                        <li class="text-base text-gray-600">Designed and implemented RESTful APIs for mobile and web client consumption.</li>
                        <li class="text-base text-gray-600">Built cross-platform mobile applications from scratch using Flutter and Dart.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="shadow p-6 sm:p-10 rounded-xl grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50">
                <div class="w-full rounded-xl p-6 bg-gray-200 hover:shadow-lg transition-shadow duration-200 flex flex-col">
                    <div class="mb-4 flex justify-between items-center w-full">
                        <h3 class="text-gray-700 text-lg font-bold">E-Commerce (Laravel)</h3>
                    ...
                    <p class="text-gray-600 text-base leading-7 mb-4 flex-grow">
                        Developed a full-stack e-commerce platform using Laravel, MySQL, and TailwindCSS with RESTful APIs for product and order management.
                    </p>
                    <a href="#" target="_blank" class="text-blue-500 hover:underline font-semibold">View Project</a>
                </div>
                <div class="w-full rounded-xl p-6 bg-gray-200 hover:shadow-lg transition-shadow duration-200 flex flex-col">
                    <div class="mb-4 flex justify-between items-center w-full">
                    ...
                    <p class="text-gray-600 text-base leading-7 mb-4 flex-grow">
                        Built a cross-platform mobile app using Flutter & Dart, with Firebase authentication and API integration for real-time data syncing.
                    </p>
                    <a href="#" target="_blank" class="text-blue-500 hover:underline font-semibold">View Project</a>
                </div>
            </div>
        ...
        <div class="mt-6 p-4 sm:p-6 shadow space-y-4">
            ...
            <div class="shadow text-center p-8 sm:p-10 rounded-xl w-full md:w-4/5 lg:w-3/5 mx-auto space-y-4">
                ...
                <p class="text-gray-500 text-base sm:text-lg leading-8">
                    I'm always interested in discussing new opportunities. Whether you have a question or just want to say hi, feel free to reach out!
                </p>
                {{-- Buttons now use flex-wrap to stack on small screens. --}}
                <div class="flex items-center justify-center flex-wrap gap-3 pt-4">
                    <a href="https://www.facebook.com/yoeung.yeng.7" target="_blank" class="px-4 py-2 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors duration-200">Facebook</a>
                    <a href="https://www.linkedin.com/feed/" target="_blank" class="px-4 py-2 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors duration-200">LinkedIn</a>
                    <a href="https://github.com/YoeungYeng" target="_blank" class="px-4 py-2 bg-gray-800 text-white rounded-xl hover:bg-gray-900 transition-colors duration-200">GitHub</a>
                    <a href="mailto:yoeungyeng760@gmail.com" target="_blank" class="px-4 py-2 bg-red-500 text-white rounded-xl hover:bg-red-600 transition-colors duration-200">Email Me</a>
                </div>
            </div>
        </div>
    </section>
